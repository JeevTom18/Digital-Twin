...
import { Logo, DashboardIcon, EyeIcon, ImpactIcon, FileTextIcon, BookOpenIcon, LogoutIcon } from '../icons';
...
const PublicSidebar: React.FC<PublicSidebarProps> = ({ currentPage, onNavigate, onLogout, isSidebarOpen }) => {
  const navItems = [
    { page: 'public-dashboard', icon: <DashboardIcon />, label: 'Dashboard' },
    { page: 'policy-explorer', icon: <EyeIcon />, label: 'Policy Explorer' },
    { page: 'public-impact-analysis', icon: <ImpactIcon />, label: 'Impact Analysis' },
    { page: 'reports-library', icon: <FileTextIcon />, label: 'Reports Library' },
    { page: 'learn', icon: <BookOpenIcon />, label: 'Learn' },
  ];
      ...
      <div className="p-4 border-t border-slate-200">
        <div className="flex items-center">
            ...
            <div className="ml-3 flex-1">
                <p className="text-sm font-semibold text-slate-800">{UserRole.Public}</p>
